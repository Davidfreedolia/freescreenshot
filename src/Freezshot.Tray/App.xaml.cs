...
{
    private const string SingleInstanceMutexName = @"Global\Freedolia.Freezshot.Singleton";
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        Freezshot.UI.DarkTitleBar.HookAll();
        ...
        {
            MessageBox.Show(
                "Freezshot ja s'està executant a la safata.",
                "Freezshot",
                MessageBoxButton.OK,

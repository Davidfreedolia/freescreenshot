...
namespace Freezshot.Core.Localization;
...
public static class Strings
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> All = new()
    {
        ["ca"] = new()
        {
            ...
            ["settings.privacy.sub"] = "Tres senyals opt-in que Freezshot envia a freedolia.com. Pots desactivar-los aquí.",
            ...
            ["settings.about.sub"] = "Freezshot · una eina de freedolia.com",
            ...
            ["uninstall.title"] = "Per què desinstal·les Freezshot?",
            ...
            ["onboarding.step1.body"] = "Mira a baix a la dreta, prop del rellotge. Prem la fletxa amunt (^) per expandir la safata; la icona teal de Freezshot hi és. Arrossega-la fora del quadret expandit cap a la barra del rellotge perquè es quedi sempre visible.",
            ...
            ["editor.tool.line"] = "Línia",
            ["editor.tool.marker"] = "Marcador",
            ["editor.tool.number"] = "Numerar",
            ["settings.output.format"] = "Format",
            ["settings.output.format.png"] = "PNG (sense pèrdua)",
            ["settings.output.format.jpg"] = "JPG (més petit)",
            ["settings.capture.preview.title"] = "Mostrar miniatura després de capturar",
            ["settings.capture.preview.desc"] = "Apareix una miniatura uns segons a baix-dreta. Clica-la per obrir la imatge.",
        ...
        ["es"] = new()
        {
            ...
            ["menu.donate"] = "Donar",
            ["menu.quit"] = "Salir",
            ["settings.title"] = "Freezshot — Configuración",
            ["settings.nav.general"] = "General",
            ...
            ["settings.privacy.sub"] = "Tres señales opt-in que Freezshot envía a freedolia.com. Puedes desactivarlas aquí.",
            ...
            ["settings.about.sub"] = "Freezshot · una herramienta de freedolia.com",
            ...
            ["uninstall.title"] = "¿Por qué desinstalas Freezshot?",
            ...
            ["onboarding.title"] = "Bienvenido a Freezshot",
            ...
            ["onboarding.step1.body"] = "Mira abajo a la derecha, cerca del reloj. Pulsa la flecha arriba (^) para expandir la bandeja; el icono teal de Freezshot está ahí. Arrástralo fuera del cuadro expandido hasta la barra del reloj para que quede siempre visible.",
            ...
            ["editor.tool.marker"] = "Marcador",
            ["editor.tool.number"] = "Numerar",
            ["settings.output.format"] = "Formato",
            ["settings.output.format.png"] = "PNG (sin pérdida)",
            ["settings.output.format.jpg"] = "JPG (más pequeño)",
            ["settings.capture.preview.title"] = "Mostrar miniatura tras capturar",
            ["settings.capture.preview.desc"] = "Aparece una miniatura unos segundos abajo-derecha. Haz clic para abrir la imagen.",
        ...
        ["en"] = new()
        {
            ...
            ["menu.donate"] = "Donate",
            ["menu.quit"] = "Quit",
            ["settings.title"] = "Freezshot — Settings",
            ["settings.nav.general"] = "General",
            ...
            ["settings.privacy.sub"] = "Three opt-in signals Freezshot sends to freedolia.com. You can turn them off here.",
            ...
            ["settings.about.sub"] = "Freezshot · a freedolia.com tool",
            ...
            ["uninstall.title"] = "Why are you uninstalling Freezshot?",
            ...
            ["onboarding.title"] = "Welcome to Freezshot",
            ...
            ["onboarding.step1.body"] = "Look at the bottom-right, near the clock. Click the up-arrow (^) to expand the tray; the teal Freezshot icon is in there. Drag it out of the expanded box onto the clock bar so it stays visible.",
            ...
            ["editor.tool.number"] = "Numbering",
            ["settings.output.format"] = "Format",
            ["settings.output.format.png"] = "PNG (lossless)",
            ["settings.output.format.jpg"] = "JPG (smaller)",
            ["settings.capture.preview.title"] = "Show thumbnail after capture",
            ["settings.capture.preview.desc"] = "A thumbnail appears for a few seconds at bottom-right. Click it to open the image.",

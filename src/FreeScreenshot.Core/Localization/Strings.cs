...
public static class Strings
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> All = new()
    {
        ["ca"] = new()
        {
            ...
            ["onboarding.step1.body"] = "Mira a baix a la dreta, prop del rellotge. Prem la fletxa amunt (^) per expandir la safata; la icona teal de FreeScreenshot hi és. Arrossega-la fora del quadret expandit cap a la barra del rellotge perquè es quedi sempre visible.",
        ...
        ["es"] = new()
        {
            ...
            ["onboarding.step1.body"] = "Mira abajo a la derecha, cerca del reloj. Pulsa la flecha arriba (^) para expandir la bandeja; el icono teal de FreeScreenshot está ahí. Arrástralo fuera del cuadro expandido hasta la barra del reloj para que quede siempre visible.",
        ...
        ["en"] = new()
        {
            ...
            ["onboarding.step1.body"] = "Look at the bottom-right, near the clock. Click the up-arrow (^) to expand the tray; the teal FreeScreenshot icon is in there. Drag it out of the expanded box onto the clock bar so it stays visible.",
